...
class _ReturnStage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cannotReturnHere =
        station?.isUnderMaintenance == true ||
            station?.isTerminated == true;
    return SurfacePanel(
        ...
        children: [
          ...
          Text(
            station != null
                ...
                : context.l10n.chooseReturnStation,
            style: theme.textTheme.titleMedium?.copyWith(
              fontWeight: FontWeight.w900,
            ),
          ),
          if (station?.isUnderMaintenance == true) ...[
          ...
          if (controller.error != null) ...[
            ...
            const SizedBox(height: 18),
            _ErrorPanel(
              message: context.l10n.chooseReturnStationDescription,
            ),
          ] else if (cannotReturnHere) ...[
            const SizedBox(height: 18),
            _ErrorPanel(
              message: station.isUnderMaintenance
